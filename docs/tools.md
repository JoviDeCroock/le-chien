...
| `read_url`             | Fetches a URL and returns extracted text content. HTML is stripped to plain text. Falls back to Cloudflare Browser Rendering for JS-heavy or bot-protected pages. Truncated to 12k chars. | BROWSER binding  |
