...
const TOOL_LABELS: Record<string, { label: string; icon: string }> = {
  ...
  microsoft_search_files: { label: "Search Files", icon: "files" },
  microsoft_read_file: { label: "Read File", icon: "file" },
  microsoft_search_teams: { label: "Search Teams", icon: "teams" },
};
    ...
    <svg width={14} height={14} viewBox="0 0 24 24" class="shrink-0">
      ...
      {type === "file" && (
        <>
          ...
          <path d="M16 13H8M16 17H8M10 9H8" {...s} />
        </>
      )}
      {type === "teams" && (
        <>
