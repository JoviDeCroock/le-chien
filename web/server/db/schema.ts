...
export const dailyMessageUsage = sqliteTable(
  "daily_message_usage",
  {
    id: text("id").primaryKey(),
    userId: text("user_id")
...
export const dailyImageGenerationUsage = sqliteTable(
  ...
  (t) => [
    uniqueIndex("daily_image_generation_usage_user_date_unique_idx").on(t.userId, t.usageDate),
  ],
);

export const dailyWebSearchUsage = sqliteTable(
  "daily_web_search_usage",
  {
    id: text("id").primaryKey(),
    userId: text("user_id")
      .notNull()
